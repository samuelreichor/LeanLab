<template>
  <CategoryLanding
    ...
    description="Fleischfrei und trotzdem proteinreich: Unsere vegetarischen Rezepte beweisen, dass man auch ohne Fleisch genug Eiweiß für Muskelaufbau und Fitness bekommt."
    icon="i-lucide-leaf"
    :seo="{
